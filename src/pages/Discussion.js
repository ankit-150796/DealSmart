...
import {FaDownload, FaHome, FaFilter, FaEye, FaTrash, FaSearch, FaPen, FaPlus} from 'react-icons/fa';
    ...
    <>
      ...
      <div className="content-wrapper table-full-bx">
        <div className="page-heading">
            <ol className="breadcrumb">
                ...
                <li className="breadcrumb-item"><h1 className="page-title"> Discussion </h1></li>
            </ol>
        ...
        <div className="fade-in-up ibox">
            <div class="total-stats">
                <div class="col"><Link>Total Discussions<span>2430</span></Link></div>
                <div class="col"><Link>Pending Discussions   <span>4</span></Link></div>
            ...
            <div className="table-scroll">
                <table className="table table-striped table-bordered table-hover" id="example-table" cellspacing="0">
                    ...
                    <tbody>
                        <tr>
                            <td><Link to={'/Discussion/DiscussionDetails'}> 1 </Link></td>
                            <td><Link to={'/Discussion/DiscussionDetails'}>Lorem Ipsum</Link></td>
                            <td><Link to={'/Discussion/DiscussionDetails'}>John</Link></td>
                            <td><Link to={'/Discussion/DiscussionDetails'}>Lorem ipsum dolor sit amet,</Link></td>
                            <td><Link to={'/Discussion/DiscussionDetails'}>10</Link></td>
                            <td><Link to={'/Discussion/DiscussionDetails'}> 50</Link></td>
                            <td>
                                <div className="action-wrap table-action">
                                    <Tippy content="View Detail">
                                        <Link to={'/Discussion/DiscussionDetails'}><FaEye/></Link>
                                    </Tippy>
                                    <Tippy content="Edit">
                                      <Link><FaPen/></Link>
                                    </Tippy>
                        ...
                        <tr>
                            <td><Link to={'/Discussion/DiscussionDetails'}> 2 </Link></td>
                            <td><Link to={'/Discussion/DiscussionDetails'}>Lorem Ipsum</Link></td>
                            <td><Link to={'/Discussion/DiscussionDetails'}>John</Link></td>
                            <td><Link to={'/Discussion/DiscussionDetails'}>Lorem ipsum dolor sit amet,</Link></td>
                            <td><Link to={'/Discussion/DiscussionDetails'}>10</Link></td>
                        ...
                        <tr>
                            <td><Link to={'/Discussion/DiscussionDetails'}> 3 </Link></td>
                            <td><Link to={'/Discussion/DiscussionDetails'}>Lorem Ipsum</Link></td>
                            <td><Link to={'/Discussion/DiscussionDetails'}>John</Link></td>
                            <td><Link to={'/Discussion/DiscussionDetails'}>Lorem ipsum dolor sit amet,</Link></td>
                            <td><Link to={'/Discussion/DiscussionDetails'}>10</Link></td>
      ...
      <div class="add-more-container" >
            <Tippy content=" Add Discussion">
              <Link to={'/AddDiscussion'}> <FaPlus/> </Link>
            </Tippy>
        </div>
