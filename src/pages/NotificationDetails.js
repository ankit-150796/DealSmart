            ...
            <div className="page-heading detail">
                <ol className="breadcrumb">
                    <li className="breadcrumb-item">
                        <Link to={'/Notification'}><FaAngleLeft/> </Link>
                    </li>
                    <li className="breadcrumb-item"><h1 className="page-title"> Notification Detail </h1></li>
                </ol>
            </div>
            <div className="fade-in-up ibox">
                <div className="user-details">
                    <div className="ibox-title"><span> Notification Information</span></div>
